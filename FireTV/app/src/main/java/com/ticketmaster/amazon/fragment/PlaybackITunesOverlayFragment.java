 ...
 */
public class PlaybackITunesOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
    ...
    private static final int BACKGROUND_TYPE = PlaybackITunesOverlayFragment.BG_NONE;
    ...
    private String itunesThumbUrl;
    private String itunesAudioUrl;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        itunesTitle = intent.getStringExtra(ITunesActivity.ITUNES_TITLE);
        itunesThumbUrl = intent.getStringExtra(ITunesActivity.ITUNES_THUMB_URL);
        itunesAudioUrl = intent.getStringExtra(ITunesActivity.ITUNES_AUDIO_URL);
        mCurrentItem = 0;
    ...
    public void togglePlayback(boolean playPause) {
        if (playPause) {
            ...
            mCallback.onFragmentPlayPause(itunesAudioUrl,
    ...
    private void addPlaybackControlsRow() {
        if (SHOW_DETAIL) {
            mPlaybackControlsRow = new PlaybackControlsRow(itunesTitle);
        } else {
...
//        }
    ...
    private int getUpdatePeriod() {
        if (getView() == null
                || mPlaybackControlsRow.getTotalTime() <= 0
                || getView().getWidth() == 0) {
    ...
    private void next() {
        ...
        if (mPlayPauseAction.getIndex() == PlayPauseAction.PLAY) {
            mCallback.onFragmentPlayPause(itunesAudioUrl, 0, false);
        } else {
            mCallback.onFragmentPlayPause(itunesAudioUrl, 0, true);
        }
        updatePlaybackRow(mCurrentItem);
    }
    ...
    public interface OnPlayPauseClickedListener {
        void onFragmentPlayPause(String itunesItem, int position, Boolean playPause);
    }
    ...
    static class DescriptionPresenter extends AbstractDetailsDescriptionPresenter {
        ...
        protected void onBindDescription(ViewHolder viewHolder, Object item) {
            ...
            viewHolder.getSubtitle().setText(""); //TODO: add info
        }
    }
}
