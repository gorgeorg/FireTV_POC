...
public class SearchFragment extends android.support.v17.leanback.app.SearchFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mVideoCursorAdapter.setMapper(new CursorMapper() {
            @Override
        ...
        setBadgeDrawable(getResources().getDrawable(android.support.v17.leanback.R.drawable.lb_ic_in_app_search, null));
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(
                getActivity(),
                Uri.EMPTY,//VideoContract.VideoEntry.CONTENT_URI,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if (cursor != null && cursor.moveToFirst()) {
            ...
            mRowsAdapter.clear();
            HeaderItem header = new HeaderItem(/*getString(R.string.search_results, mQuery)*/"Header");
            ListRow row = new ListRow(header, mVideoCursorAdapter);
            mRowsAdapter.add(row);
        } else {
            // No results were found.
            mRowsAdapter.clear();
            HeaderItem header = new HeaderItem(/*getString(R.string.no_search_results, mQuery)*/"no results");
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            displayCompletions(Arrays.asList(new String[]{"word1", "word2"}));
